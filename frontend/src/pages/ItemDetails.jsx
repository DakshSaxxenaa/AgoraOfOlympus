...
const ItemDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 sm:p-6 mt-6 sm:mt-10 bg-[#1f2937]/80 backdrop-blur-lg rounded-xl shadow-lg text-white">
      ...
      <h2 className="text-2xl sm:text-3xl font-bold mb-2">{item.name}</h2>
      <p className="text-xs sm:text-sm text-gray-400 mb-2">{item.category} | {item.rarity}</p>
      <p className="mb-4 text-gray-200 text-sm sm:text-base">{item.description}</p>
      ...
      {isOwner && (
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          <button
            ...
            className="w-full sm:w-auto bg-yellow-500 hover:bg-yellow-400 text-white text-xs sm:text-sm px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg transition-all"
          >
            Edit
          </button>
          <button
            ...
            className="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg transition-all"
          >
            Delete
          </button>
        </div>
      ...
      {!isOwner && (
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center mb-4">
          <button
            ...
            className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white text-xs sm:text-sm px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg transition-all"
          >
            Contact Seller
          </button>
          <button
            onClick={addToCart}
            className="w-full sm:w-auto bg-yellow-500 hover:bg-yellow-600 text-white text-xs sm:text-sm px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg transition-all"
          >
            Add to Cart
          </button>
          <button
            ...
            className="sm:ml-auto text-3xl cursor-pointer self-center"
          >
            {wished ? (
      ...
      <div className="mt-6 p-4 bg-[#111827]/80 rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
